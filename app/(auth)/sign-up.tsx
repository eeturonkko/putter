...
export default function SignUpScreen() {
  ...
  const canVerify = code.trim().length >= 4 && isLoaded && !submitting;
  ...
  const onVerifyPress = async () => {
    ...
    try {
      ...
      if (attempt.status === "complete") {
        ...
        setError("Vahvistus ei valmistunut. Yritä uudelleen.");
      }
    } catch (e: any) {
      const msg =
        e?.errors?.[0]?.longMessage ||
      ...
      >
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
          <View style={styles.container}>
            ...
            {!pendingVerification ? (
              <>
                <Text style={[styles.title, { color: c.fg }]}>Luo tili</Text>
                ...
                >
                  ...
                  <Text
                    style={[styles.label, { color: c.muted, marginTop: 10 }]}
                  >
                    Salasana
                  </Text>
                  <TextInput
                  ...
                  <View style={styles.altRow}>
                    <Text style={{ color: c.muted }}>Onko jo tili?</Text>
              ...
              <>
                ...
                <Text style={[styles.subtitle, { color: c.muted }]}>
                  Syötä sähköpostiisi saapunut vahvistuskoodi.
                </Text>
                ...
                >
                  ...
                  <Pressable
                    ...
                    style={[
                      styles.button,
                      { backgroundColor: canVerify ? c.primary : c.disabled },
                    ]}
                  >
                    {submitting ? (
                      <ActivityIndicator />
                  ...
                  <View style={[styles.altRow, { justifyContent: "center" }]}>
                    <Link href="/(auth)/sign-in" asChild>
                      <Pressable android_ripple={{ color: c.ripple }}>
                        <Text style={[styles.altLink, { color: c.primary }]}>
